...
ActiveRecord::Schema.define(version: 2020_07_22_030834) do
  ...
  create_table "product_types", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "name"
    t.string "description"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "system_coupons", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.index ["product_type_id"], name: "index_system_coupons_on_product_type_id"
  end
